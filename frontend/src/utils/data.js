...
export const FEATURES = [
  ...
  },
  {
    ...
    description: "Automatically generate polite and effectively payment reminder emails for overdue invoices with a single click."
  },
  {
    icon: FileText,
...
export const FAQS = [
  {
    ...
    answer: "Simply paste any text that contains invoice details-like email, a list of items or a work summary and our AI will instantly parse it to pre-file a new invoice for you, saving your time and effort."
  },
  {
    question: "Is there a free trail available?",
    answer: "Yes, you can try our platform for free for 14 days. If you want, we'll provide you with a free, personalized 30-minute onboading call to get you up and running as soom as possible."
  },
  {
  ...
  },
  {
    ...
    answer: "We understand that things change, You can cancel you at any time and we'll refund you the difference already paid."
  },
  {
