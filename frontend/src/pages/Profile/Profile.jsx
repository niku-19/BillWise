...
const Profile = () => {
  ...
  if (loading) {
    return <div className='flex justify-center w-8 h-8 animate-spin'><Loader2 className=' w-8 h-8 animate-spin' /></div>
  }
  return (
        ...
        <div className='p-6 space-y-6'>
          <div>
            ...
            <div className='relative'>
              ...
              <input type='email' readOnly value={user?.email || ''} disabled className='w-full h-10 pl-10 pr-3 py-2 border border-slate-200 rounded-lg bg-slate-50 text-slate-500 disabled:cursor-not-allowed' />
            </div>
          </div>
          ...
          <div className='pt-6 border-t border-slate-200'>
            ...
            <div className='space-y-4'>
              ...
              <TextareaField label="Address" name="address" icon={MapPin} value={formData.address} onChange={handleInputChange} placeholder="123 Street, HSR Layout, Bengaluru" />
              <InputField label="phone" name="phone" icon={Phone} type="tel" value={formData.phone} onChange={handleInputChange} placeholder="(555) 123-456" />
            </div>
          </div>
        </div>
