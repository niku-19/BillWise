...
import { AlertCircle, Edit, FileText, Loader2, Mail, Plus, Search, Sparkle, Sparkles, Trash2 } from 'lucide-react';
...
const AllInvoices = () => {
  ...
  if (loading) {
    return <div className='flex justify-center items-center h-96 animate-spin text-blue-600'>
      <Loader2 className='' />
    </div>
  }
      ...
      <div className='bg-white border border-slate-200 rounded-lg shadow-sm'>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-grow">
              ...
              <input
                ...
                className='w-full f-10 pl-10 pr-4 py-2 border border-slate-200 rounded-lg bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500'
                value={searchTerm}
        ...
        {filteredInvoices.length === 0 ? (
          <div className='flex flex-col items-center justify-center py-12 text-center'>
            <div className='w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center m-4'>
          ...
          <div className='w-[90w] md:w-auto overflow-x-auto'>
