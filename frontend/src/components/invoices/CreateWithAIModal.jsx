  ...
  return (
    <div className='fixed inset-0 z-50 overflow-y-auto'>
      <div className="flex items-center justify-center min-h-screen px-4 text-center">
        <div className="fixed inset-0 bg-black/10 bg-opacity-50 transition" onClick={onClose}></div>
        ...
        <div className='bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all'>
          <div className='flex items-center justify-between mb-4'>
            <h3 className='text-lg font-semibold text-slate-900 flex items-center'>
              <Sparkle className='w-5 h-5 mr-2 text-blue-600' />
          ...
          <div className='space-y-4'>
            <p className='text-sm text-slate-600'>
              Paste any text that contains invoice details (like client name, items, quantities, and prices) and AI will attempt to create an invoice from it.
            </p>
            <TextareaField
              name="invoiceText"
              ...
              placeholder="eg., 'Invoice for ClientCorp: 2 hours of design work at $150/hr and 1 logo for $500"
              rows={8}
            />
          </div>
